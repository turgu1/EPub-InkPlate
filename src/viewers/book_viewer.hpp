...
class BookViewer {
  ...
  private:
    BookViewer(Fonts &fonts, const char *language) : page(Page::Make(fonts, language)) {};
    ...
    auto recreatePage(EPubPtr &epub) -> bool;
  ...
  public:
    ...
    static inline auto Make(Fonts &fonts, const char *language) { return makeUniqueHimem<BookViewer>(fonts, language); }
