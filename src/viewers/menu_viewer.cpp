...
auto MenuViewer::show(MenuEntry *theMenu, uint8_t entryIndex, bool clearScreen) -> void {
  ...
  // LOG_I("MenuViewer::show: menuEntryCount={}, visibleEntryCount={}, iconWidth={}, "
  //       "spaceBetweenIcons={}, iconLineHeight={}, maxIconsPerLine={}, iconsLineCount={}, "
  //       "textYPos={}, regionHeight={}",
