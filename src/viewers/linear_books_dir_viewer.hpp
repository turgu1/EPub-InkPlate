...
class LinearBooksDirViewer : public BooksDirViewer {
  private:
    ...
    static const int16_t TITLE_FONT            = SYSTEM_REGULAR_FONT_INDEX;
    static const int16_t AUTHOR_FONT           = SYSTEM_ITALIC_FONT_INDEX;
    ...
    auto showPage(int16_t pageNbr, int16_t hightlightItemIdx) -> void;
    auto highlight(int16_t itemIdx) -> void;
  ...
  public:
    ...
    auto showPageAndHighlight(int16_t bookIdx) -> int16_t;
    auto highlightBook(int16_t bookIdx) -> void;
