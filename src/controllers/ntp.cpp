  ...
  auto NTP::getAndSetTime() -> bool {
      ...
      if (wifi.startSta()) {
        ...
        // Extract the 32 bits that represent the time-stamp seconds (since NTP epoch) from when the
        // packet left the server. Subtract 70 years worth of seconds from the seconds since 1900.
        // This leaves the seconds since the UNIX epoch of 1970.
        // (1900)------------------(1970)**************************************(Time Packet Left the
        // Server)
