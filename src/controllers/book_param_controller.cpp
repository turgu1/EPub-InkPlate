...
static void revert_to_defaults() {
  ...
  msg_viewer.show(MsgViewer::MsgType::INFO, false, false, "E-book parameters reverted",
...
static void books_list() { app_controller.set_controller(AppController::Ctrl::DIR); }

static void delete_book() {
  msg_viewer.show(MsgViewer::MsgType::CONFIRM, true, false, "Delete e-book",
                  "The e-book \"%s\" will be deleted. Are you sure?", epub.get_title());
  book_param_controller.set_delete_current_book();
}

static void toc_ctrl() { app_controller.set_controller(AppController::Ctrl::TOC); }
  ...
  if (book_params_form_is_shown) {
    ...
    if (msg_viewer.confirm(event, ok)) {
      if (ok) {
        ...
        msg_viewer.show(MsgViewer::MsgType::INFO, false, false, "Canceled",
      ...
      msg_viewer.show(MsgViewer::MsgType::INFO, false, true, "Restarting",
