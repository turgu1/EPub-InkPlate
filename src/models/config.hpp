...
// clang-format on
  ...
  Config::CfgType Config::cfg = {{
      ...
      {Config::Ident::FONT_SIZE,          Config::EntryType::BYTE,   "fontSize",     &fontSize,              &defaultFontSize,        0},
      ...
      {Config::Ident::SHOW_TITLE,         Config::EntryType::BYTE,   "showTitle",    &showTitle,             &defaultShowTitle,       0},
