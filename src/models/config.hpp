...
enum class ConfigIdent {
    ...
    ORIENTATION, USE_FONTS_IN_BOOKS, DEFAULT_FONT, SHOW_PICTURES, PIXEL_RESOLUTION, SHOW_HEAP,   SHOW_TITLE,
    FRONT_LIGHT, DIR_VIEW,           COVER_SIZE,   DNS_NAME,      AP_SSID,          AP_PWD,
  #if DATE_TIME_RTC
...
// clang-format on
  ...
  static const int8_t  default_show_pictures      =  0; // 0 = NO, 1 = YES
  ...
  static const int8_t  default_cover_size         =  0; // 0 = SMALL, 1 = LARGE
  ...
  Config::CfgType Config::cfg = {{
      ...
      {Config::Ident::SHOW_PICTURES,      Config::EntryType::BYTE,   "show_images",  &show_pictures, &default_show_pictures, 0},
      ...
      {Config::Ident::COVER_SIZE,         Config::EntryType::BYTE,   "cover_size",   &cover_size,    &default_cover_size,    0},
