...
public:
  ...
  bool load_font(const std::string filename, const std::string font_family,
  ...
  inline const std::string &get_current_item_file_path() const {
    return current_item_info.file_path;
  }
