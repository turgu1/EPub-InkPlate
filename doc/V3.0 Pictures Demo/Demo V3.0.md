...
The pictures were taken using an iPad camera and geometrically modified to only keep the Inkplate screen as a corrected rectangle using the Gimp application under Linux. Beyond that, the pictures have not be modified, so, for some of them, you will see phantom images pertaining to the eInk display. As the application is refreshing the eInk after every 10 screen updates, the phantom images then disappear.
...
<img src="./IMG_3102.JPG" alt="picture" width="600"/>

2. EBooks directory

The standard EBooks directory as per all the version of the application.

<img src="./IMG_3103.JPG" alt="picture" width="600"/>
