...
JRESULT jdec_prepare (JDEC * jd, size_t (*infunc)(JDEC *, uint8_t *, size_t), void* pool, size_t sz_pool, void* dev);
JRESULT jdec_decomp  (JDEC * jd, int (*outfunc)(JDEC *, void *, JRECT *), uint8_t scale);
